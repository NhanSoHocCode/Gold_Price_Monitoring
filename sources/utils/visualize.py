...
def generate_gold_charts():
    ...
    try:
        ...
        query_latest = """
            ...
            FROM gold_mart.stg_gold_prices
            WHERE price_timestamp = (SELECT MAX(price_timestamp) FROM gold_mart.stg_gold_prices)
        ...
        query_hourly = """
            SELECT *
            FROM gold_mart.fct_gold_prices
            ORDER BY price_hour 
        """
